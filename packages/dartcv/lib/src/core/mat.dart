...
class Mat extends CvStruct<cvg.Mat> {
  ...
  Mat _opScalar(
    Scalar other,
    ffi.Pointer<cvg.CvStatus> Function(cvg.Mat, cvg.Scalar) func, {
    bool inplace = false,
  }) {
    if (inplace) {
      cvRun(() => func(ref, other.ref));
  ...
  Mat add<T>(T val, {bool inplace = false}) {
    return switch (val) {
      ...
      Scalar() => addScalar(val as Scalar, inplace: inplace),
  ...
  Mat addScalar(Scalar other, {bool inplace = false}) =>
      _opScalar(other, ccore.cv_Mat_op_add_scalar, inplace: inplace);
  ...
  Mat subtract<T>(T val, {bool inplace = false}) {
    return switch (val) {
      ...
      Scalar() => subtractScalar(val as Scalar, inplace: inplace),
      int() => switch (type.depth) {
  ...
  Mat subtractScalar(Scalar other, {bool inplace = false}) =>
      _opScalar(other, ccore.cv_Mat_op_sub_scalar, inplace: inplace);
  ...
  Mat multiply<T>(T val, {bool inplace = false}) {
    return switch (val) {
      ...
      Scalar() => multiplyScalar(val as Scalar, inplace: inplace),
      int() => switch (type.depth) {
  ...
  Mat multiplyScalar(Scalar other, {bool inplace = false}) =>
      _opScalar(other, ccore.cv_Mat_op_mul_scalar, inplace: inplace);
  ...
  Mat divide<T>(T val, {bool inplace = false}) {
    return switch (val) {
      ...
      Scalar() => divideScalar(val as Scalar, inplace: inplace),
      int() => switch (type.depth) {
  ...
  Mat divideScalar(Scalar other, {bool inplace = false}) =>
      _opScalar(other, ccore.cv_Mat_op_div_scalar, inplace: inplace);
