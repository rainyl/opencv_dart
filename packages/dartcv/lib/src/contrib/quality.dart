...
class QualityBRISQUE extends CvStruct<ccontrib.QualityBRISQUE> {
  ...
  factory QualityBRISQUE.create(String modelFile, String rangeFile) {
    final p = calloc<ccontrib.QualityBRISQUE>();
  ...
  Scalar compute(Mat img) {
    final p = calloc<ccontrib.Scalar>();
  ...
  @override
  ccontrib.QualityBRISQUE get ref => ptr.ref;
}

class QualityGMSD extends CvStruct<ccontrib.QualityGMSD> {
  ...
  factory QualityGMSD.create(Mat img) {
    final p = calloc<ccontrib.QualityGMSD>();
...
class QualityMSE extends CvStruct<ccontrib.QualityMSE> {
  ...
  factory QualityMSE.create(Mat img) {
    final p = calloc<ccontrib.QualityMSE>();
...
class QualityPSNR extends CvStruct<ccontrib.QualityPSNR> {
  ...
  factory QualityPSNR.create(Mat img, {double maxPixelValue = 255}) {
    final p = calloc<ccontrib.QualityPSNR>();
...
class QualitySSIM extends CvStruct<ccontrib.QualitySSIM> {
  ...
  factory QualitySSIM.create(Mat img) {
    final p = calloc<ccontrib.QualitySSIM>();
