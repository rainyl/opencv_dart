...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(imp$1.MatIn, imp$1.MatOut, imp$1.MatOut, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(StereoBM, imp$1.MatIn, imp$1.MatIn, imp$1.MatOut)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Int, ffi.Int, ffi.Pointer<StereoBM>, imp$1.CvCallback_0)>()
...
external void cv_StereoSGBM_close(
  StereoSGBMPtr self$1,
);

@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(StereoSGBM, imp$1.MatIn, imp$1.MatIn, imp$1.MatOut)>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(imp$1.MatIn, ffi.Int, imp$1.MatIn, imp$1.MatOut, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(imp$1.MatIn, imp$1.MatOut, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(imp$1.MatIn, imp$1.MatOut, imp$1.MatOut, imp$1.MatOut, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, CvSize, VecPoint2f, ffi.Bool, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, Mat, Mat, CvSize, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, Mat, Mat, Mat, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, CvSize, ffi.Bool, ffi.Pointer<Mat>, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, Mat, CvSize, ffi.Int, Mat, Mat, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(imp$1.MatIn, imp$1.MatIn, imp$1.MatOut, imp$1.MatOut, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, Mat, Mat, Mat, imp$1.TermCriteria, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, Mat, imp$1.TermCriteria, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, Mat, Mat, Mat, TermCriteria, imp$1.CvCallback_0)>()
...
class _SymbolAddresses {
  ...
  ffi.Pointer<ffi.NativeFunction<ffi.Void Function(StereoBMPtr)>> get cv_StereoBM_close =>
      ffi.Native.addressOf(self.cv_StereoBM_close);
  ffi.Pointer<ffi.NativeFunction<ffi.Void Function(StereoSGBMPtr)>> get cv_StereoSGBM_close =>
      ffi.Native.addressOf(self.cv_StereoSGBM_close);
}
...
final class StereoBM extends ffi.Struct {
  ...
  static ffi.Pointer<StereoBM> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Void> ptr,
  }) => $allocator<StereoBM>()..ref.ptr = ptr;
}
...
final class StereoSGBM extends ffi.Struct {
  ...
  static ffi.Pointer<StereoSGBM> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Void> ptr,
  }) => $allocator<StereoSGBM>()..ref.ptr = ptr;
}
