...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(AlignMTB, VecMat, ffi.Pointer<VecMat>, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(MergeMertens, VecMat, Mat, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, ffi.Float, ffi.Float, ffi.Float, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Int, ffi.Int, ffi.Bool, ffi.Pointer<AlignMTB>)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Float, ffi.Float, ffi.Float, ffi.Pointer<MergeMertens>)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(VecMat, Mat, ffi.Int, ffi.Int, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(Mat, Mat, ffi.Float, ffi.Float, ffi.Int, ffi.Int, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, Mat, ffi.Float, ffi.Int, ffi.Int, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, ffi.Float, ffi.Float, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, ffi.Float, ffi.Int, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, CvPoint, Mat, ffi.Int, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, ffi.Float, ffi.Float, ffi.Int, imp$1.CvCallback_0)
>()
...
class _SymbolAddresses {
  ...
  ffi.Pointer<ffi.NativeFunction<ffi.Void Function(AlignMTBPtr)>> get cv_AlignMTB_close =>
      ffi.Native.addressOf(self.cv_AlignMTB_close);
...
final class AlignMTB extends ffi.Struct {
  ...
  static ffi.Pointer<AlignMTB> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Void> ptr,
  }) => $allocator<AlignMTB>()..ref.ptr = ptr;
}
...
final class MergeMertens extends ffi.Struct {
  ...
  static ffi.Pointer<MergeMertens> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Void> ptr,
  }) => $allocator<MergeMertens>()..ref.ptr = ptr;
}
