...
@ffi.Native<ffi.Pointer<CvStatus> Function(AlignMTB, VecMat, ffi.Pointer<VecMat>, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(MergeMertens, VecMat, Mat, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, ffi.Float, ffi.Float, ffi.Float, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(VecMat, Mat, ffi.Int, ffi.Int, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(
        VecMat, Mat, ffi.Int, ffi.Int, ffi.Float, ffi.Float, ffi.Int, ffi.Int, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(Mat, Mat, ffi.Float, ffi.Float, ffi.Int, ffi.Int, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, Mat, ffi.Float, ffi.Int, ffi.Int, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, ffi.Float, ffi.Float, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, ffi.Float, ffi.Int, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, CvPoint, Mat, ffi.Int, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, Mat, Mat, ffi.Float, ffi.Float, ffi.Int, imp1.CvCallback_0)>()
