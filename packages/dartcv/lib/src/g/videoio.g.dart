...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Int, ffi.Int, ffi.Pointer<VideoCapture>, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(VideoCapture, ffi.Int, ffi.Pointer<ffi.Bool>, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(VideoCapture, ffi.Int, ffi.Int, ffi.Pointer<ffi.Bool>, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(VideoCapture, Mat, ffi.Pointer<ffi.Bool>, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(VideoCapture, Mat, ffi.Int, ffi.Pointer<ffi.Bool>, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(VideoWriter, Mat, imp$1.CvCallback_0)>()
...
final class VideoCapture extends ffi.Struct {
  ...
  static ffi.Pointer<VideoCapture> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Void> ptr,
  }) => $allocator<VideoCapture>()..ref.ptr = ptr;
}
...
final class VideoWriter extends ffi.Struct {
  ...
  static ffi.Pointer<VideoWriter> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Void> ptr,
  }) => $allocator<VideoWriter>()..ref.ptr = ptr;
}
