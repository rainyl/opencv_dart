...
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Pointer<ffi.Char>, ffi.Pointer<CascadeClassifier>)>()
external ffi.Pointer<CvStatus> cv_CascadeClassifier_create_1(
  ffi.Pointer<ffi.Char> filename,
  ffi.Pointer<CascadeClassifier> rval,
);

@ffi.Native<ffi.Pointer<CvStatus> Function(CascadeClassifier, Mat, ffi.Pointer<VecRect>, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(CascadeClassifier, Mat, ffi.Pointer<VecRect>, ffi.Double, ffi.Int, ffi.Int,
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(CascadeClassifier, Mat, ffi.Pointer<VecRect>, ffi.Pointer<VecI32>,
        ffi.Double, ffi.Int, ffi.Int, CvSize, CvSize, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(CascadeClassifier, Mat, ffi.Pointer<VecRect>, ffi.Pointer<VecI32>,
        ffi.Pointer<VecF64>, ffi.Double, ffi.Int, ffi.Int, CvSize, CvSize, ffi.Bool, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(CascadeClassifier, ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Int>)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>, CvSize, ffi.Float, ffi.Float,
        ffi.Int, ffi.Int, ffi.Int, ffi.Pointer<FaceDetectorYN>)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(ffi.Pointer<ffi.Char>, VecUChar, VecUChar, CvSize, ffi.Float, ffi.Float,
        ffi.Int, ffi.Int, ffi.Int, ffi.Pointer<FaceDetectorYN>)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(FaceDetectorYN, Mat, ffi.Pointer<Mat>, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(FaceRecognizerSF, Mat, Mat, ffi.Pointer<Mat>, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(
        ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>, ffi.Int, ffi.Int, ffi.Pointer<FaceRecognizerSF>)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(FaceRecognizerSF, Mat, ffi.Bool, ffi.Pointer<Mat>, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(
        FaceRecognizerSF, Mat, Mat, ffi.Int, ffi.Pointer<ffi.Double>, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(
        HOGDescriptor, Mat, ffi.Pointer<VecF32>, CvSize, CvSize, ffi.Pointer<VecPoint>, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(HOGDescriptor, Mat, Mat, Mat, CvSize, CvSize, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Pointer<ffi.Char>, ffi.Pointer<HOGDescriptor>)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(HOGDescriptor, Mat, ffi.Pointer<VecPoint>, ffi.Pointer<VecF64>, ffi.Double,
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(HOGDescriptor, Mat, ffi.Pointer<VecPoint>, ffi.Double, CvSize, CvSize,
...
@ffi.Native<ffi.Pointer<CvStatus> Function(HOGDescriptor, Mat, ffi.Pointer<VecRect>, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(HOGDescriptor, Mat, ffi.Double, CvSize, CvSize, ffi.Double, ffi.Double,
        ffi.Bool, ffi.Pointer<VecRect>, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(
        HOGDescriptor, ffi.Pointer<VecRect>, ffi.Pointer<VecF64>, ffi.Int, ffi.Double, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(HOGDescriptor, ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Bool>)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Pointer<VecRect>, ffi.Int, ffi.Double, imp1.CvCallback_0)>()
