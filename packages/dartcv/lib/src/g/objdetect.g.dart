...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(CascadeClassifier, Mat, ffi.Pointer<VecRect>, imp$1.CvCallback_0)
>()
external ffi.Pointer<CvStatus> cv_CascadeClassifier_detectMultiScale(
  CascadeClassifier self$1,
  Mat img,
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(FaceDetectorYN, Mat, ffi.Pointer<Mat>, imp$1.CvCallback_0)>()
external ffi.Pointer<CvStatus> cv_FaceDetectorYN_detect(
  FaceDetectorYN self$1,
  Mat img,
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(FaceRecognizerSF, Mat, Mat, ffi.Pointer<Mat>, imp$1.CvCallback_0)
>()
external ffi.Pointer<CvStatus> cv_FaceRecognizerSF_alignCrop(
  FaceRecognizerSF self$1,
  Mat src_img,
  Mat face_box,
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(FaceRecognizerSF, Mat, ffi.Bool, ffi.Pointer<Mat>, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(HOGDescriptor, Mat, Mat, Mat, CvSize, CvSize, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(HOGDescriptor, Mat, ffi.Pointer<VecRect>, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Pointer<VecRect>, ffi.Int, ffi.Double, imp$1.CvCallback_0)>()
...
final class CascadeClassifier extends ffi.Struct {
  ...
  static ffi.Pointer<CascadeClassifier> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Void> ptr,
  }) => $allocator<CascadeClassifier>()..ref.ptr = ptr;
}
...
final class FaceDetectorYN extends ffi.Struct {
  ...
  static ffi.Pointer<FaceDetectorYN> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Pointer<ffi.Void>> ptr,
  }) => $allocator<FaceDetectorYN>()..ref.ptr = ptr;
}
...
final class FaceRecognizerSF extends ffi.Struct {
  ...
  static ffi.Pointer<FaceRecognizerSF> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Pointer<ffi.Void>> ptr,
  }) => $allocator<FaceRecognizerSF>()..ref.ptr = ptr;
}
...
final class HOGDescriptor extends ffi.Struct {
  ...
  static ffi.Pointer<HOGDescriptor> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Void> ptr,
  }) => $allocator<HOGDescriptor>()..ref.ptr = ptr;
}
...
final class QRCodeDetector extends ffi.Struct {
  ...
  static ffi.Pointer<QRCodeDetector> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Void> ptr,
  }) => $allocator<QRCodeDetector>()..ref.ptr = ptr;
}
