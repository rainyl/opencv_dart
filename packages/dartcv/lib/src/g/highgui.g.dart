...
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>, ffi.Int)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Pointer<ffi.Char>, ffi.Pointer<CvRect>)>()
external ffi.Pointer<CvStatus> cv_getWindowImageRect(
  ffi.Pointer<ffi.Char> winname,
  ffi.Pointer<CvRect> rval,
);

@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Pointer<ffi.Char>, ffi.Int, ffi.Pointer<ffi.Double>)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Pointer<ffi.Char>, ffi.Int, ffi.Int)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(Mat, ffi.Bool, ffi.Bool, ffi.Bool, ffi.Pointer<CvRect>)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Pointer<ffi.Char>, cv_MouseCallback, ffi.Pointer<ffi.Void>)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Pointer<ffi.Char>, ffi.Int, ffi.Double)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)>()
...
typedef cv_MouseCallbackFunction =
    ffi.Void Function(ffi.Int event, ffi.Int x, ffi.Int y, ffi.Int flags, ffi.Pointer<ffi.Void> userdata);
typedef Dartcv_MouseCallbackFunction =
    void Function(int event, int x, int y, int flags, ffi.Pointer<ffi.Void> userdata);
