...
@ffi.Native<ffi.Pointer<CvStatus> Function(Layer, ffi.Pointer<ffi.Pointer<ffi.Char>>)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(Layer, ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Int>)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(
        VecRect, VecF32, ffi.Float, ffi.Float, ffi.Pointer<VecI32>, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(
        VecRect, VecF32, ffi.Float, ffi.Float, ffi.Pointer<VecI32>, ffi.Float, ffi.Int, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(Net, ffi.Pointer<ffi.Pointer<ffi.Char>>)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(Net, ffi.Pointer<ffi.Char>, ffi.Pointer<Mat>, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(Net, ffi.Pointer<ffi.Char>, ffi.Pointer<AsyncArray>)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(Net, ffi.Pointer<VecMat>, VecVecChar, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(Net, ffi.Pointer<Net>, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(Net, ffi.Pointer<VecVecChar>, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(Net, ffi.Pointer<VecI32>, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(VecUChar, VecUChar, ffi.Pointer<Net>, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Pointer<ffi.Char>, ffi.Pointer<Net>, imp1.CvCallback_0)>()
...
@ffi.Native<ffi.Pointer<CvStatus> Function(VecUChar, ffi.Pointer<Net>, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(
        ffi.Pointer<ffi.Char>, ffi.Bool, ffi.Bool, ffi.Pointer<Net>, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(Net, Mat, ffi.Pointer<ffi.Char>, ffi.Double, Scalar, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(
        Mat, Mat, ffi.Double, CvSize, Scalar, ffi.Bool, ffi.Bool, ffi.Int, imp1.CvCallback_0)>()
...
@ffi.Native<
    ffi.Pointer<CvStatus> Function(
        VecMat, Mat, ffi.Double, CvSize, Scalar, ffi.Bool, ffi.Bool, ffi.Int, imp1.CvCallback_0)>()
...
class _SymbolAddresses {
  ...
  ffi.Pointer<ffi.NativeFunction<ffi.Void Function(LayerPtr)>> get cv_dnn_Layer_close =>
      ffi.Native.addressOf(self.cv_dnn_Layer_close);
  ffi.Pointer<ffi.NativeFunction<ffi.Void Function(NetPtr)>> get cv_dnn_Net_close =>
      ffi.Native.addressOf(self.cv_dnn_Net_close);
}
