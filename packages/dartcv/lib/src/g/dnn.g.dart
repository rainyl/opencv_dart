...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(Net, ffi.Pointer<ffi.Char>, ffi.Pointer<Mat>, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(Net, ffi.Pointer<VecMat>, VecVecChar, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(Net, ffi.Pointer<Net>, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(Net, ffi.Pointer<VecF32>, ffi.Pointer<VecI32>, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(Net, ffi.Pointer<VecVecChar>, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(Net, ffi.Pointer<ffi.Int64>, ffi.Pointer<VecF64>, imp$1.CvCallback_0)
>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(Net, ffi.Pointer<VecI32>, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(VecUChar, VecUChar, ffi.Pointer<Net>, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(ffi.Pointer<ffi.Char>, ffi.Pointer<Net>, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<ffi.Pointer<CvStatus> Function(VecUChar, ffi.Pointer<Net>, imp$1.CvCallback_0)>()
...
@meta.RecordUse()
@ffi.Native<
  ffi.Pointer<CvStatus> Function(Net, Mat, ffi.Pointer<ffi.Char>, ffi.Double, Scalar, imp$1.CvCallback_0)
>()
...
final class AsyncArray extends ffi.Struct {
  ...
  static ffi.Pointer<AsyncArray> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Void> ptr,
  }) => $allocator<AsyncArray>()..ref.ptr = ptr;
}
...
final class Layer extends ffi.Struct {
  ...
  static ffi.Pointer<Layer> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Void> ptr,
  }) => $allocator<Layer>()..ref.ptr = ptr;
}
...
final class Net extends ffi.Struct {
  ...
  static ffi.Pointer<Net> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Void> ptr,
  }) => $allocator<Net>()..ref.ptr = ptr;
}
