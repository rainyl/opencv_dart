...
# Set dependencies (transitive closure)
set(_dartcv_deps_changed TRUE)
while(_dartcv_deps_changed)
  set(_dartcv_deps_changed FALSE)

  if(BUILD_opencv_imgcodecs AND NOT BUILD_opencv_imgproc)
    set(BUILD_opencv_imgproc ON CACHE BOOL "Build imgproc module" FORCE)
    set(_dartcv_deps_changed TRUE)
  endif()

  if(BUILD_opencv_videoio)
    foreach(dep imgproc imgcodecs)
      if(NOT BUILD_opencv_${dep})
        set(BUILD_opencv_${dep} ON CACHE BOOL "Build ${dep} module" FORCE)
        set(_dartcv_deps_changed TRUE)
      endif()
    endforeach()
  endif()

  if(BUILD_opencv_dnn AND NOT BUILD_opencv_imgproc)
    set(BUILD_opencv_imgproc ON CACHE BOOL "Build imgproc module" FORCE)
    set(_dartcv_deps_changed TRUE)
  endif()

  if(BUILD_opencv_gapi AND NOT BUILD_opencv_imgproc)
    set(BUILD_opencv_imgproc ON CACHE BOOL "Build imgproc module" FORCE)
    set(_dartcv_deps_changed TRUE)
  endif()

  if(BUILD_opencv_features2d)
    foreach(dep imgproc flann)
      if(NOT BUILD_opencv_${dep})
        set(BUILD_opencv_${dep} ON CACHE BOOL "Build ${dep} module" FORCE)
        set(_dartcv_deps_changed TRUE)
      endif()
  ...
  if(BUILD_opencv_highgui AND NOT BUILD_opencv_imgproc)
    set(BUILD_opencv_imgproc ON CACHE BOOL "Build imgproc module" FORCE)
    set(_dartcv_deps_changed TRUE)
  endif()

  if(BUILD_opencv_calib3d)
    foreach(dep imgproc features2d flann)
      if(NOT BUILD_opencv_${dep})
        set(BUILD_opencv_${dep} ON CACHE BOOL "Build ${dep} module" FORCE)
        set(_dartcv_deps_changed TRUE)
      endif()
  ...
  if(BUILD_opencv_objdetect)
    foreach(dep imgproc calib3d)
      if(NOT BUILD_opencv_${dep})
        set(BUILD_opencv_${dep} ON CACHE BOOL "Build ${dep} module" FORCE)
        set(_dartcv_deps_changed TRUE)
      endif()
  ...
  if(BUILD_opencv_photo AND NOT BUILD_opencv_imgproc)
    set(BUILD_opencv_imgproc ON CACHE BOOL "Build imgproc module" FORCE)
    set(_dartcv_deps_changed TRUE)
  endif()

  if(BUILD_opencv_video AND NOT BUILD_opencv_imgproc)
    set(BUILD_opencv_imgproc ON CACHE BOOL "Build imgproc module" FORCE)
    set(_dartcv_deps_changed TRUE)
  endif()

  if(BUILD_opencv_stitching)
    foreach(dep imgproc features2d calib3d flann)
      if(NOT BUILD_opencv_${dep})
        set(BUILD_opencv_${dep} ON CACHE BOOL "Build ${dep} module" FORCE)
        set(_dartcv_deps_changed TRUE)
      endif()
  ...
  if(BUILD_opencv_aruco)
    foreach(dep imgproc calib3d objdetect)
      if(NOT BUILD_opencv_${dep})
        set(BUILD_opencv_${dep} ON CACHE BOOL "Build ${dep} module" FORCE)
        set(_dartcv_deps_changed TRUE)
      endif()
  ...
  if(BUILD_opencv_img_hash AND NOT BUILD_opencv_imgproc)
    set(BUILD_opencv_imgproc ON CACHE BOOL "Build imgproc module" FORCE)
    set(_dartcv_deps_changed TRUE)
  endif()

  if(BUILD_opencv_quality)
    foreach(dep imgproc ml)
      if(NOT BUILD_opencv_${dep})
        set(BUILD_opencv_${dep} ON CACHE BOOL "Build ${dep} module" FORCE)
        set(_dartcv_deps_changed TRUE)
      endif()
  ...
  if(BUILD_opencv_wechat_qrcode)
    foreach(dep imgproc objdetect dnn)
      if(NOT BUILD_opencv_${dep})
        set(BUILD_opencv_${dep} ON CACHE BOOL "Build ${dep} module" FORCE)
        set(_dartcv_deps_changed TRUE)
      endif()
  ...
  if(BUILD_opencv_ximgproc)
    foreach(dep imgproc calib3d imgcodecs video)
      if(NOT BUILD_opencv_${dep})
        set(BUILD_opencv_${dep} ON CACHE BOOL "Build ${dep} module" FORCE)
        set(_dartcv_deps_changed TRUE)
      endif()
  ...
  if(BUILD_opencv_xobjdetect)
    foreach(dep imgproc objdetect imgcodecs)
      if(NOT BUILD_opencv_${dep})
        set(BUILD_opencv_${dep} ON CACHE BOOL "Build ${dep} module" FORCE)
        set(_dartcv_deps_changed TRUE)
      endif()
