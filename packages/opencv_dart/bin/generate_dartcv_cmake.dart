...
void main(List<String> args) {
  ...
  if (yaml is YamlMap && yaml['dartcv_modules'] != null) {
    ...
    if (config['exclude'] != null) {
      for (final m in (config['exclude'] as Iterable)) {
        if (knownModules.contains(m as String)) modules[m as String] = false;
      }
    }
    if (config['include'] != null) {
      ...
      for (final m in (config['include'] as Iterable)) {
        if (knownModules.contains(m as String)) modules[m as String] = true;
      }
    }
  }
