...
class ArucoDetector extends CvStruct<ccontrib.ArucoDetector> {
  ...
  static final finalizer = OcvFinalizer<ccontrib.ArucoDetectorPtr>(ccontrib.addresses.ArucoDetector_Close);
...
class ArucoDetectorParameters extends CvStruct<ccontrib.ArucoDetectorParameters> {
  ArucoDetectorParameters._(
    ccontrib.ArucoDetectorParametersPtr ptr, [
    bool attach = true,
  ...
  factory ArucoDetectorParameters.empty() {
    final p = calloc<ccontrib.ArucoDetectorParameters>();
    cvRun(() => ccontrib.ArucoDetectorParameters_Create(p));
    return ArucoDetectorParameters._(p);
  }

  @override
  ccontrib.ArucoDetectorParameters get ref => ptr.ref;
  static final finalizer = OcvFinalizer<ccontrib.ArucoDetectorParametersPtr>(
