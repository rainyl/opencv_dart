...
abstract class NativeArray<T extends ffi.NativeType, P extends num> with EquatableMixin implements ffi.Finalizable, INativeArray<P> {
...
class U8Array extends NativeArray<ffi.Uint8, int>{
  ...
  static final finalizer = Finalizer<ffi.Pointer<ffi.Uint8>>((p) {
    print("Free U8Array.ptr=$p");
    calloc.free(p);
  });
