...
Future<Mat> addAsync(Mat src1, Mat src2, {Mat? mask, int dtype = -1}) async =>
    cvRunAsync(
      (callback) => ccore.core_Add_Async(
          src1.ref, src2.ref, mask?.ref ?? Mat.empty().ref, dtype, callback),
      matCompleter,
    );
...
Future<Mat> addWeightedAsync(
  ...
  int dtype = -1,
    ...
    cvRunAsync(
      (callback) => ccore.core_AddWeighted_Async(
          src1.ref, alpha, src2.ref, beta, gamma, dtype, callback),
      matCompleter,
    );
  ...
  InputArray? mask,
    ...
    cvRunAsync(
      (callback) => mask == null
          ...
          : ccore.core_BitwiseAndWithMask_Async(
              src1.ref, src2.ref, mask.ref, callback),
      matCompleter,
    );
...
Future<Mat> bitwiseNOTAsync(InputArray src, {InputArray? mask}) async =>
    cvRunAsync(
      (callback) => mask == null
...
Future<Mat> bitwiseORAsync(InputArray src1, InputArray src2,
        {InputArray? mask}) async =>
    cvRunAsync(
      (callback) => mask == null
          ? ccore.core_BitwiseOr_Async(src1.ref, src2.ref, callback)
          : ccore.core_BitwiseOrWithMask_Async(
              src1.ref, src2.ref, mask.ref, callback),
      matCompleter,
    );
...
Future<Mat> bitwiseXORAsync(InputArray src1, InputArray src2,
        {InputArray? mask}) async =>
    cvRunAsync(
      (callback) => mask == null
          ? ccore.core_BitwiseXor_Async(src1.ref, src2.ref, callback)
          : ccore.core_BitwiseXorWithMask_Async(
              src1.ref, src2.ref, mask.ref, callback),
      matCompleter,
    );
...
Future<int> borderInterpolateAsync(int p, int len, int borderType) async =>
    cvRunAsync(
      (callback) =>
          ccore.core_BorderInterpolate_Async(p, len, borderType, callback),
      intCompleter,
    );
...
Future<(bool, Point)> checkRangeAsync(
  ...
  double maxVal = CV_F64_MAX,
    ...
    cvRunAsync2(
        (callback) =>
            ccore.core_CheckRange_Async(a.ref, quiet, minVal, maxVal, callback),
        (completer, p, p1) {
...
Future<Mat> compareAsync(InputArray src1, InputArray src2, int cmpop) async =>
    cvRunAsync(
        (callback) =>
            ccore.core_Compare_Async(src1.ref, src2.ref, cmpop, callback),
        matCompleter);
...
Future<int> countNonZeroAsync(Mat src) async => cvRunAsync(
    (callback) => ccore.core_CountNonZero_Async(src.ref, callback),
    intCompleter);
...
Future<Mat> completeSymmAsync(InputOutputArray m,
        {bool lowerToUpper = false}) async =>
    cvRunAsync0(
      (callback) =>
          ccore.core_CompleteSymm_Async(m.ref, lowerToUpper, callback),
      (c) => c.complete(m),
    );
...
Future<Mat> convertScaleAbsAsync(
  ...
  double beta = 0,
    ...
    cvRunAsync(
        (callback) =>
            ccore.core_ConvertScaleAbs_Async(src.ref, alpha, beta, callback),
        matCompleter);
...
Future<Mat> dctAsync(InputArray src, {int flags = 0}) async => cvRunAsync(
    (callback) => ccore.core_DCT_Async(src.ref, flags, callback), matCompleter);
...
Future<double> determinantAsync(InputArray mtx) async => cvRunAsync(
    (callback) => ccore.core_Determinant_Async(mtx.ref, callback),
    doubleCompleter);
...
Future<Mat> dftAsync(
  ...
  int nonzeroRows = 0,
    ...
    cvRunAsync(
        (callback) =>
            ccore.core_DFT_Async(src.ref, flags, nonzeroRows, callback),
        matCompleter);
...
Future<Mat> divideAsync(
  ...
  int dtype = -1,
    ...
    cvRunAsync(
      (callback) =>
          ccore.core_Divide_Async(src1.ref, src2.ref, scale, dtype, callback),
      matCompleter,
    );
...
Future<(bool ret, Mat eigenvalues, Mat eigenvectors)> eigenAsync(
        InputArray src) async =>
    cvRunAsync3((callback) => ccore.core_Eigen_Async(src.ref, callback),
        (completer, p, p1, p2) {
      final rval = p.cast<ffi.Bool>().value;
      calloc.free(p);
      completer.complete((
...
Future<(Mat mean, Mat result)> PCABackProjectAsync(
        Mat src, Mat mean, Mat eigenVectors) async =>
    cvRunAsync(
      (callback) => ccore.core_PCABackProject_Async(
          src.ref, mean.ref, eigenVectors.ref, callback),
      (completer, p) =>
...
Future<(Mat mean, Mat eigenvalues, Mat eigenvectors)> PCAComputeAsync(
  ...
  int maxComponents = 0,
    ...
    cvRunAsync2(
        (callback) => ccore.core_PCACompute_Async(
            data.ref, mean.ref, maxComponents, callback), (completer, p, p1) {
      completer.complete(
        (
          mean,
...
Future<(Mat mean, Mat eigenvectors)> PCACompute1Async(
  ...
  int maxComponents = 0,
    ...
    cvRunAsync(
      (callback) => ccore.core_PCACompute_1_Async(
          data.ref, mean.ref, maxComponents, callback),
      (completer, p) =>
          completer.complete((mean, Mat.fromPointer(p.cast<cvg.Mat>()))),
    );
...
Future<(Mat mean, Mat eigenvectors)> PCACompute2Async(
  ...
  double retainedVariance = 0,
    ...
    cvRunAsync(
      (callback) => ccore.core_PCACompute_3_Async(
          data.ref, mean.ref, retainedVariance, callback),
      (completer, p) =>
          completer.complete((mean, Mat.fromPointer(p.cast<cvg.Mat>()))),
    );
...
Future<(Mat mean, Mat eigenvalues, Mat eigenvectors)> PCACompute3Async(
  ...
  double retainedVariance = 0,
    ...
    cvRunAsync2(
      (callback) => ccore.core_PCACompute_2_Async(
          data.ref, mean.ref, retainedVariance, callback),
...
Future<(Mat mean, Mat result)> PCAProjectAsync(
        InputArray src, InputArray mean, InputArray eigenVectors) =>
    cvRunAsync(
        (callback) => ccore.core_PCAProject_Async(
            src.ref, mean.ref, eigenVectors.ref, callback), (completer, p) {
      completer.complete((mean, Mat.fromPointer(p.cast<cvg.Mat>())));
    });
...
Future<Mat> expAsync(InputArray src) async => cvRunAsync(
    (callback) => ccore.core_Exp_Async(src.ref, callback), matCompleter);
...
Future<Mat> extractChannelAsync(InputArray src, int coi) async => cvRunAsync(
    (callback) => ccore.core_ExtractChannel_Async(src.ref, coi, callback),
    matCompleter);
...
Future<Mat> findNonZeroAsync(InputArray src) async => cvRunAsync(
    (callback) => ccore.core_FindNonZero_Async(src.ref, callback),
    matCompleter);
...
Future<Mat> flipAsync(InputArray src, int flipCode) async => cvRunAsync(
    (callback) => ccore.core_Flip_Async(src.ref, flipCode, callback),
    matCompleter);
...
Future<Mat> gemmAsync(
  ...
  int flags = 0,
    ...
    cvRunAsync(
      (callback) => ccore.core_Gemm_Async(
          src1.ref, src2.ref, alpha, src3.ref, beta, flags, callback),
      matCompleter,
    );
...
Future<int> getOptimalDFTSizeAsync(int vecsize) async => cvRunAsync(
    (callback) => ccore.core_GetOptimalDFTSize_Async(vecsize, callback),
    intCompleter);
...
Future<Mat> hconcatAsync(InputArray src1, InputArray src2) async => cvRunAsync(
    (callback) => ccore.core_Hconcat_Async(src1.ref, src2.ref, callback),
    matCompleter);
...
Future<Mat> vconcatAsync(InputArray src1, InputArray src2) async => cvRunAsync(
    (callback) => ccore.core_Vconcat_Async(src1.ref, src2.ref, callback),
    matCompleter);
...
Future<Mat> rotateAsync(InputArray src, int rotateCode) async => cvRunAsync(
    (callback) => ccore.core_Rotate_Async(src.ref, rotateCode, callback),
    matCompleter);
...
Future<Mat> idctAsync(
  ...
  int flags = 0,
    ...
    cvRunAsync((callback) => ccore.core_Idct_Async(src.ref, flags, callback),
        matCompleter);
...
Future<Mat> idftAsync(
  ...
  int nonzeroRows = 0,
    ...
    cvRunAsync(
        (callback) =>
            ccore.core_Idft_Async(src.ref, flags, nonzeroRows, callback),
        matCompleter);
...
Future<Mat> inRangeAsync(
  ...
  InputArray upperb,
    ...
    cvRunAsync(
      (callback) =>
          ccore.core_InRange_Async(src.ref, lowerb.ref, upperb.ref, callback),
      matCompleter,
    );
...
Future<Mat> inRangebyScalarAsync(
  ...
  Scalar upperb,
    ...
    cvRunAsync(
      (callback) => ccore.core_InRangeWithScalar_Async(
          src.ref, lowerb.ref, upperb.ref, callback),
      matCompleter,
    );
...
Future<Mat> insertChannelAsync(
        InputArray src, InputOutputArray dst, int coi) async =>
    cvRunAsync0(
      (callback) =>
          ccore.core_InsertChannel_Async(src.ref, dst.ref, coi, callback),
      (c) => c.complete(dst),
    );
...
Future<(double rval, Mat dst)> invertAsync(
  ...
  int flags = DECOMP_LU,
    ...
    cvRunAsync2<(double, Mat)>(
        (callback) => ccore.core_Invert_Async(src.ref, flags, callback),
        (c, p, p1) {
...
Future<(double rval, Mat bestLabels, Mat centers)> kmeansAsync(
  ...
  int flags,
    ...
    cvRunAsync2(
        (callback) => ccore.core_KMeans_Async(data.ref, K, bestLabels.ref,
            criteria.cvd.ref, attempts, flags, callback), (completer, p, p1) {
      final rval = p.cast<ffi.Double>().value;
      calloc.free(p);
      completer
          .complete((rval, bestLabels, Mat.fromPointer(p1.cast<cvg.Mat>())));
    });
...
Future<Mat> logAsync(InputArray src) async => cvRunAsync(
    (callback) => ccore.core_Log_Async(src.ref, callback), matCompleter);
...
Future<Mat> LUTAsync(InputArray src, InputArray lut) async => cvRunAsync(
    (callback) => ccore.core_LUT_Async(src.ref, lut.ref, callback),
    matCompleter);
...
Future<Mat> magnitudeAsync(InputArray x, InputArray y) async => cvRunAsync(
    (callback) => ccore.core_Magnitude_Async(x.ref, y.ref, callback),
    matCompleter);
...
Future<Mat> maxAsync(InputArray src1, InputArray src2) async => cvRunAsync(
    (callback) => ccore.core_Max_Async(src1.ref, src2.ref, callback),
    matCompleter);
...
Future<(Scalar mean, Scalar stddev)> meanStdDevAsync(InputArray src,
        {InputArray? mask}) async =>
    cvRunAsync2(
      (callback) => mask == null
      ...
      (c, p, p1) => c.complete((
        Scalar.fromPointer(p.cast<cvg.Scalar>()),
        Scalar.fromPointer(p1.cast<cvg.Scalar>())
      )),
    );
...
Future<Mat> mergeAsync(VecMat mv) async => cvRunAsync(
    (callback) => ccore.core_Merge_Async(mv.ref, callback), matCompleter);
...
Future<Mat> minAsync(InputArray src1, InputArray src2) async => cvRunAsync(
    (callback) => ccore.core_Min_Async(src1.ref, src2.ref, callback),
    matCompleter);
  ...
  InputArray? mask,
    ...
    cvRunAsync4(
        (callback) => mask == null
            ...
            : ccore.core_MinMaxIdx_Mask_Async(src.ref, mask.ref, callback),
        (c, p, p1, p2, p3) {
...
Future<(double minVal, double maxVal, Point minLoc, Point maxLoc)>
    minMaxLocAsync(
  InputArray src, {
  InputArray? mask,
}) async =>
        cvRunAsync4(
            (callback) => mask == null
                ...
                : ccore.core_MinMaxLoc_Mask_Async(src.ref, mask.ref, callback),
            (c, p, p1, p2, p3) {
          final minv = p.cast<ffi.Double>().value;
          calloc.free(p);
          final maxv = p1.cast<ffi.Double>().value;
          ...
          c.complete((
            minv,
            maxv,
            Point.fromPointer(p2.cast()),
            Point.fromPointer(p3.cast())
          ));
        });
...
Future<VecMat> mixChannelsAsync(VecMat src, VecMat dst, VecI32 fromTo) async =>
    cvRunAsync0(
      (callback) =>
          ccore.core_MixChannels_Async(src.ref, dst.ref, fromTo.ref, callback),
      (c) => c.complete(dst),
    );
...
Future<Mat> mulSpectrumsAsync(
  ...
  bool conjB = false,
    ...
    cvRunAsync(
      (callback) =>
          ccore.core_MulSpectrums_Async(a.ref, b.ref, flags, conjB, callback),
      matCompleter,
    );
...
Future<Mat> multiplyAsync(
  ...
  int dtype = -1,
    ...
    cvRunAsync(
      (callback) => ccore.core_MultiplyWithParams_Async(
          src1.ref, src2.ref, scale, dtype, callback),
      matCompleter,
    );
...
Future<Mat> normalizeAsync(
  ...
  InputArray? mask,
    ...
    cvRunAsync0(
      (callback) => mask == null
          ? ccore.core_Normalize_Async(
              src.ref, dst.ref, alpha, beta, normType, dtype, callback)
...
Future<double> norm1Async(
  ...
  // InputArray? mask,
    ...
    cvRunAsync(
      (callback) =>
          ccore.core_NormWithMats_Async(src1.ref, src2.ref, normType, callback),
      doubleCompleter,
    );
...
Future<Mat> perspectiveTransformAsync(InputArray src, InputArray m) async =>
    cvRunAsync(
        (callback) =>
            ccore.core_PerspectiveTransform_Async(src.ref, m.ref, callback),
        matCompleter);
...
Future<(bool ret, Mat dst)> solveAsync(
  ...
  int flags = DECOMP_LU,
    ...
    cvRunAsync2(
        (callback) =>
            ccore.core_Solve_Async(src1.ref, src2.ref, flags, callback),
        (c, p, p1) {
      final rval = p.cast<ffi.Bool>().value;
      calloc.free(p);
      c.complete((rval, Mat.fromPointer(p1.cast<cvg.Mat>())));
...
Future<(int rval, Mat roots)> solveCubicAsync(InputArray coeffs) async =>
    cvRunAsync2((callback) => ccore.core_SolveCubic_Async(coeffs.ref, callback),
        (c, p, p1) {
...
Future<(double rval, Mat roots)> solvePolyAsync(
  ...
  int maxIters = 300,
    ...
    cvRunAsync2(
        (callback) =>
            ccore.core_SolvePoly_Async(coeffs.ref, maxIters, callback),
        (c, p, p1) {
      final rval = p.cast<ffi.Double>().value;
      calloc.free(p);
      c.complete((rval, Mat.fromPointer(p1.cast<cvg.Mat>())));
...
Future<Mat> reduceAsync(InputArray src, int dim, int rtype,
        {int dtype = -1}) async =>
    cvRunAsync(
        (callback) =>
            ccore.core_Reduce_Async(src.ref, dim, rtype, dtype, callback),
        matCompleter);
...
Future<Mat> reduceArgMaxAsync(InputArray src, int axis,
        {bool lastIndex = false}) async =>
    cvRunAsync(
        (callback) =>
            ccore.core_ReduceArgMax_Async(src.ref, axis, lastIndex, callback),
        matCompleter);
...
Future<Mat> reduceArgMinAsync(InputArray src, int axis,
        {bool lastIndex = false}) async =>
    cvRunAsync(
        (callback) =>
            ccore.core_ReduceArgMin_Async(src.ref, axis, lastIndex, callback),
        matCompleter);
...
Future<Mat> repeatAsync(InputArray src, int ny, int nx) async => cvRunAsync(
    (callback) => ccore.core_Repeat_Async(src.ref, ny, nx, callback),
    matCompleter);
...
Future<Mat> scaleAddAsync(
        InputArray src1, double alpha, InputArray src2) async =>
    cvRunAsync(
        (callback) =>
            ccore.core_ScaleAdd_Async(src1.ref, alpha, src2.ref, callback),
        matCompleter);
...
Future<Mat> setIdentityAsync(InputOutputArray mtx, {Scalar? s}) async =>
    cvRunAsync0(
      (callback) => ccore.core_SetIdentity_Async(
          mtx.ref, s?.ref ?? Scalar.all(1).ref, callback),
      (c) => c.complete(mtx),
    );
...
Future<Mat> sortAsync(InputArray src, int flags) async => cvRunAsync(
    (callback) => ccore.core_Sort_Async(src.ref, flags, callback),
    matCompleter);
...
Future<Mat> sortIdxAsync(InputArray src, int flags) async => cvRunAsync(
    (callback) => ccore.core_SortIdx_Async(src.ref, flags, callback),
    matCompleter);
...
Future<Mat> subtractAsync(
  ...
  int dtype = -1,
    ...
    cvRunAsync(
      (callback) => ccore.core_Subtract_Async(
          src1.ref, src2.ref, mask?.ref ?? Mat.empty().ref, dtype, callback),
      matCompleter,
    );
...
Future<Scalar> traceAsync(InputArray mtx) async => cvRunAsync(
    (callback) => ccore.core_Trace_Async(mtx.ref, callback), scalarCompleter);

/// Transform performs the matrix transformation of every array element.
///
/// For further details, please see:
/// https://docs.opencv.org/master/d2/de8/group__core__array.html#ga393164aa54bb9169ce0a8cc44e08ff22
Future<Mat> transformAsync(InputArray src, InputArray m) async => cvRunAsync(
    (callback) => ccore.core_Transform_Async(src.ref, m.ref, callback),
    matCompleter);
...
Future<Mat> transposeAsync(InputArray src) async => cvRunAsync(
    (callback) => ccore.core_Transpose_Async(src.ref, callback), matCompleter);
...
Future<Mat> powAsync(InputArray src, double power) async => cvRunAsync(
    (callback) => ccore.core_Pow_Async(src.ref, power, callback), matCompleter);
...
Future<(Mat x, Mat y)> polarToCartAsync(
  ...
  bool angleInDegrees = false,
    ...
    cvRunAsync2(
      (callback) => ccore.core_PolarToCart_Async(
          magnitude.ref, angle.ref, angleInDegrees, callback),
      matCompleter2,
    );
...
Future<Mat> phaseAsync(InputArray x, InputArray y,
        {bool angleInDegrees = false}) async =>
    cvRunAsync(
        (callback) =>
            ccore.core_Phase_Async(x.ref, y.ref, angleInDegrees, callback),
        matCompleter);
...
Future<Mat> randnAsync(
        InputOutputArray dst, Scalar mean, Scalar stddev) async =>
    cvRunAsync0(
  ...
  Rng? rng,
    ...
    cvRunAsync0(
      (callback) => rng == null
          ...
          : ccore.RandShuffleWithParams_Async(
              dst.ref, iterFactor, rng.ref, callback),
      (c) => c.complete(dst),
    );
