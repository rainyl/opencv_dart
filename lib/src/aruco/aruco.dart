...
class ArucoDetector implements ffi.Finalizable {
  ...
  factory ArucoDetector.create(
    ...
    final _ptr =
        _bindings.ArucoDetector_NewWithParams(dictionary.ptr, parameters.ptr);
    return ArucoDetector._(_ptr);
  }
  ...
  static final finalizer =
      ffi.NativeFinalizer(_bindings.addresses.ArucoDetector_Close);
  ...
  (List<List<Point2f>>, List<int>, List<List<Point2f>>) detectMarkers(
    InputArray image,
  ) {
    return using<(List<List<Point2f>>, List<int>, List<List<Point2f>>)>(
        (arena) {
      ...
      _bindings.ArucoDetector_DetectMarkers(
          _ptr, image.ptr, pvsCorners, cmarkerIds, pvsRejected);
      _bindings.Points2fVector_Close(pvsCorners);
      _bindings.Points2fVector_Close(pvsRejected);

      final _corners =
          List.generate(_bindings.Points2fVector_Size(pvsCorners), (i) {
      ...
      final _rejected =
          List.generate(_bindings.Points2fVector_Size(pvsRejected), (i) {
...
class ArucoDetectorParameters implements ffi.Finalizable {
  ...
  static final finalizer =
      ffi.NativeFinalizer(_bindings.addresses.ArucoDetectorParameters_Close);

  int get adaptiveThreshWinSizeMin =>
      _bindings.ArucoDetectorParameters_GetAdaptiveThreshWinSizeMin(_ptr);
  void set adaptiveThreshWinSizeMin(int value) =>
      _bindings.ArucoDetectorParameters_SetAdaptiveThreshWinSizeMin(
          _ptr, value);

  int get adaptiveThreshWinSizeMax =>
      _bindings.ArucoDetectorParameters_GetAdaptiveThreshWinSizeMax(_ptr);
  void set adaptiveThreshWinSizeMax(int value) =>
      _bindings.ArucoDetectorParameters_SetAdaptiveThreshWinSizeMax(
          _ptr, value);

  int get adaptiveThreshWinSizeStep =>
      _bindings.ArucoDetectorParameters_GetAdaptiveThreshWinSizeStep(_ptr);
  void set adaptiveThreshWinSizeStep(int value) =>
      _bindings.ArucoDetectorParameters_SetAdaptiveThreshWinSizeStep(
          _ptr, value);

  double get adaptiveThreshConstant =>
      _bindings.ArucoDetectorParameters_GetAdaptiveThreshConstant(_ptr);
  ...
  double get minMarkerPerimeterRate =>
      _bindings.ArucoDetectorParameters_GetMinMarkerPerimeterRate(_ptr);
  ...
  double get maxMarkerPerimeterRate =>
      _bindings.ArucoDetectorParameters_GetMaxMarkerPerimeterRate(_ptr);
  ...
  void set polygonalApproxAccuracyRate(double value) =>
      _bindings.ArucoDetectorParameters_SetPolygonalApproxAccuracyRate(
          _ptr, value);

  double get minCornerDistanceRate =>
      _bindings.ArucoDetectorParameters_GetMinCornerDistanceRate(_ptr);
  ...
  int get minDistanceToBorder =>
      _bindings.ArucoDetectorParameters_GetMinDistanceToBorder(_ptr);
  ...
  double get minMarkerDistanceRate =>
      _bindings.ArucoDetectorParameters_GetMinMarkerDistanceRate(_ptr);
  ...
  int get cornerRefinementMethod =>
      _bindings.ArucoDetectorParameters_GetCornerRefinementMethod(_ptr);
  ...
  int get cornerRefinementWinSize =>
      _bindings.ArucoDetectorParameters_GetCornerRefinementWinSize(_ptr);
  ...
  void set cornerRefinementMaxIterations(int value) =>
      _bindings.ArucoDetectorParameters_SetCornerRefinementMaxIterations(
          _ptr, value);
  ...
  void set cornerRefinementMinAccuracy(double value) =>
      _bindings.ArucoDetectorParameters_SetCornerRefinementMinAccuracy(
          _ptr, value);

  int get markerBorderBits =>
      _bindings.ArucoDetectorParameters_GetMarkerBorderBits(_ptr);
  void set markerBorderBits(int value) =>
      _bindings.ArucoDetectorParameters_SetMarkerBorderBits(_ptr, value);
  ...
  void set perspectiveRemovePixelPerCell(int value) =>
      _bindings.ArucoDetectorParameters_SetPerspectiveRemovePixelPerCell(
          _ptr, value);

  double get perspectiveRemoveIgnoredMarginPerCell => _bindings
      .ArucoDetectorParameters_GetPerspectiveRemoveIgnoredMarginPerCell(_ptr);
  void set perspectiveRemoveIgnoredMarginPerCell(double value) => _bindings
  ...
  void set maxErroneousBitsInBorderRate(double value) =>
      _bindings.ArucoDetectorParameters_SetMaxErroneousBitsInBorderRate(
          _ptr, value);

  double get minOtsuStdDev =>
      _bindings.ArucoDetectorParameters_GetMinOtsuStdDev(_ptr);
  void set minOtsuStdDev(double value) =>
      _bindings.ArucoDetectorParameters_SetMinOtsuStdDev(_ptr, value);

  double get errorCorrectionRate =>
      _bindings.ArucoDetectorParameters_GetErrorCorrectionRate(_ptr);
  ...
  double get aprilTagQuadDecimate =>
      _bindings.ArucoDetectorParameters_GetAprilTagQuadDecimate(_ptr);
  ...
  double get aprilTagQuadSigma =>
      _bindings.ArucoDetectorParameters_GetAprilTagQuadSigma(_ptr);
  ...
  int get aprilTagMinClusterPixels =>
      _bindings.ArucoDetectorParameters_GetAprilTagMinClusterPixels(_ptr);
  void set aprilTagMinClusterPixels(int value) =>
      _bindings.ArucoDetectorParameters_SetAprilTagMinClusterPixels(
          _ptr, value);

  int get aprilTagMaxNmaxima =>
      _bindings.ArucoDetectorParameters_GetAprilTagMaxNmaxima(_ptr);
  ...
  double get aprilTagCriticalRad =>
      _bindings.ArucoDetectorParameters_GetAprilTagCriticalRad(_ptr);
  ...
  double get aprilTagMaxLineFitMse =>
      _bindings.ArucoDetectorParameters_GetAprilTagMaxLineFitMse(_ptr);
  ...
  int get aprilTagMinWhiteBlackDiff =>
      _bindings.ArucoDetectorParameters_GetAprilTagMinWhiteBlackDiff(_ptr);
  void set aprilTagMinWhiteBlackDiff(int value) =>
      _bindings.ArucoDetectorParameters_SetAprilTagMinWhiteBlackDiff(
          _ptr, value);

  int get aprilTagDeglitch =>
      _bindings.ArucoDetectorParameters_GetAprilTagDeglitch(_ptr);
  void set aprilTagDeglitch(int value) =>
      _bindings.ArucoDetectorParameters_SetAprilTagDeglitch(_ptr, value);

  bool get detectInvertedMarker =>
      _bindings.ArucoDetectorParameters_GetDetectInvertedMarker(_ptr);
