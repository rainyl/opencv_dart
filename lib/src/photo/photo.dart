...
class MergeMertens extends CvStruct<cvg.MergeMertens> {
  ...
  static final finalizer =
      OcvFinalizer<cvg.MergeMertensPtr>(ffi.Native.addressOf(cvg.MergeMertens_Close));
...
Mat textureFlattening(
  ...
  final dst = Mat.empty();
  cvRun(() =>
      cvg.TextureFlattening(src.ref, mask.ref, dst.ref, lowThreshold, highThreshold, kernelSize));
  return dst;
}
