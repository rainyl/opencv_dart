...
extension Subdiv2DAsync on Subdiv2D {
  ...
  Future<(int rval, Point2f dstpt)> edgeDstAsync(int edge) async =>
      cvRunAsync2((callback) => CFFI.Subdiv2D_EdgeDst_Async(ref, edge, callback), (completer, p, p1) {
  ...
  Future<(int rval, Point2f nearestPt)> findNearestAsync(Point2f pt) async =>
      cvRunAsync2((callback) => CFFI.Subdiv2D_FindNearest_Async(ref, pt.ref, callback), (completer, p, p1) {
        final rval = p.cast<ffi.Int>().value;
        calloc.free(p);
        completer.complete((rval, Point2f.fromPointer(p1.cast<cvg.Point2f>())));
      });
  ...
  Future<int> getEdgeAsync(int edge, int nextEdgeType) async => cvRunAsync(
        (callback) => CFFI.Subdiv2D_GetEdge_Async(ref, edge, nextEdgeType, callback),
        intCompleter,
      );
  ...
  Future<VecVec4f> getEdgeListAsync() async => cvRunAsync1(
        (callback) => CFFI.Subdiv2D_GetEdgeList_Async(ref, callback),
        (completer, p) => completer.complete(VecVec4f.fromPointer(p.cast<cvg.VecVec4f>())),
      );
  ...
  Future<VecInt> getLeadingEdgeListAsync() async =>
      cvRunAsync((callback) => CFFI.Subdiv2D_GetLeadingEdgeList_Async(ref, callback), vecIntCompleter);
  ...
  Future<VecVec6f> getTriangleListAsync() async => cvRunAsync1(
        (callback) => CFFI.Subdiv2D_GetTriangleList_Async(ref, callback),
        (completer, p) => completer.complete(VecVec6f.fromPointer(p.cast<cvg.VecVec6f>())),
      );
  ...
  Future<int> insertAsync(Point2f pt) async =>
      cvRunAsync((callback) => CFFI.Subdiv2D_Insert_Async(ref, pt.ref, callback), intCompleter);
  ...
  Future<void> insertVecAsync(VecPoint2f pv) async => cvRunAsync0(
        (callback) => CFFI.Subdiv2D_InsertVec_Async(ref, pv.ref, callback),
        (c) => c.complete(),
      );
  ...
  Future<(int rval, int edge, int vertex)> locateAsync(Point2f pt) async =>
      cvRunAsync3((callback) => CFFI.Subdiv2D_Locate_Async(ref, pt.ref, callback), (completer, p, p1, p2) {
        final rval = p.cast<ffi.Int>().value;
        calloc.free(p);
  ...
  Future<int> nextEdgeAsync(int edge) async =>
      cvRunAsync((callback) => CFFI.Subdiv2D_NextEdge_Async(ref, edge, callback), intCompleter);
  ...
  Future<int> symEdgeAsync(int edge) async =>
      cvRunAsync((callback) => CFFI.Subdiv2D_SymEdge_Async(ref, edge, callback), intCompleter);
}
