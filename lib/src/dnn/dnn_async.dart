...
extension NetAsync on Net {
  static Future<Net> emptyAsync() async {
    final rval = await cvRunAsync<Net>(
        (callback) => CFFI.Net_Create_Async(callback), (c, p) {
  ...
  static Future<Net> fromFileAsync(String path,
      {String config = "", String framework = ""}) async {
    ...
    final rval = await cvRunAsync<Net>(
        (callback) =>
            CFFI.Net_ReadNet_Async(cPath, cConfig, cFramework, callback),
        (c, p) {
      return c.complete(Net.fromPointer(p.cast<cvg.Net>()));
    });
    calloc.free(cPath);
  ...
  static Future<Net> fromBytesAsync(String framework, Uint8List bufferModel,
    ...
    final rval = await cvRunAsync<Net>(
        (callback) => CFFI.Net_ReadNetBytes_Async(
            cFramework, bufM.ref, bufC.ref, callback), (c, p) {
      return c.complete(Net.fromPointer(p.cast<cvg.Net>()));
    });
  ...
  static Future<Net> fromCaffeAsync(String prototxt, String caffeModel) async {
    ...
    final rval = await cvRunAsync<Net>(
        (callback) => CFFI.Net_ReadNetFromCaffe_Async(cProto, cCaffe, callback),
        (c, p) {
      return c.complete(Net.fromPointer(p.cast<cvg.Net>()));
    });
    calloc.free(cProto);
  ...
  static Future<Net> fromCaffeBytesAsync(
      Uint8List bufferProto, Uint8List bufferModel) async {
    final bufP = VecUChar.fromList(bufferProto);
    final bufM = VecUChar.fromList(bufferModel);
    final rval = await cvRunAsync<Net>(
        (callback) =>
            CFFI.Net_ReadNetFromCaffeBytes_Async(bufP.ref, bufM.ref, callback),
        (c, p) {
      return c.complete(Net.fromPointer(p.cast<cvg.Net>()));
    });
    return rval;
  ...
  static Future<Net> fromOnnxAsync(String path) async {
    final cpath = path.toNativeUtf8().cast<ffi.Char>();
    final rval = await cvRunAsync<Net>(
        (callback) => CFFI.Net_ReadNetFromONNX_Async(cpath, callback), (c, p) {
      return c.complete(Net.fromPointer(p.cast<cvg.Net>()));
    });
    calloc.free(cpath);
  ...
  static Future<Net> fromOnnxBytesAsync(Uint8List bufferModel) async {
    final bufM = VecUChar.fromList(bufferModel);
    final rval = await cvRunAsync<Net>(
        (callback) => CFFI.Net_ReadNetFromONNXBytes_Async(bufM.ref, callback),
        (c, p) {
      return c.complete(Net.fromPointer(p.cast<cvg.Net>()));
    });
    return rval;
  ...
  static Future<Net> fromTensorflowAsync(String path,
      {String config = ""}) async {
    final cpath = path.toNativeUtf8().cast<ffi.Char>();
    final cconf = config.toNativeUtf8().cast<ffi.Char>();
    final rval = await cvRunAsync<Net>(
        (callback) =>
            CFFI.Net_ReadNetFromTensorflow_Async(cpath, cconf, callback),
        (c, p) {
      return c.complete(Net.fromPointer(p.cast<cvg.Net>()));
    });
    calloc.free(cpath);
  ...
  static Future<Net> fromTensorflowBytesAsync(Uint8List bufferModel,
      {Uint8List? bufferConfig}) async {
    bufferConfig ??= Uint8List(0);
    final bufM = VecUChar.fromList(bufferModel);
    final bufC = VecUChar.fromList(bufferConfig);
    final rval = await cvRunAsync<Net>(
        (callback) => CFFI.Net_ReadNetFromTensorflowBytes_Async(
            bufM.ref, bufC.ref, callback), (c, p) {
      return c.complete(Net.fromPointer(p.cast<cvg.Net>()));
    });
    return rval;
  }
  ...
  static Future<Net> fromTFLiteAsync(String path) async {
    final cpath = path.toNativeUtf8().cast<ffi.Char>();
    final rval = await cvRunAsync<Net>(
        (callback) => CFFI.Net_ReadNetFromTFLite_Async(cpath, callback),
        (c, p) {
      return c.complete(Net.fromPointer(p.cast<cvg.Net>()));
    });
    calloc.free(cpath);
  ...
  static Future<Net> fromTFLiteBytesAsync(Uint8List bufferModel) async {
    final bufM = VecUChar.fromList(bufferModel);
    final rval = await cvRunAsync<Net>(
        (callback) => CFFI.Net_ReadNetFromTFLiteBytes_Async(bufM.ref, callback),
        (c, p) {
      return c.complete(Net.fromPointer(p.cast<cvg.Net>()));
    });
    return rval;
  ...
  static Future<Net> fromTorchAsync(String path,
      {bool isBinary = true, bool evaluate = true}) async {
    final cpath = path.toNativeUtf8().cast<ffi.Char>();
    final rval = await cvRunAsync<Net>(
        (callback) => CFFI.Net_ReadNetFromTorch_Async(
            cpath, isBinary, evaluate, callback), (c, p) {
      return c.complete(Net.fromPointer(p.cast<cvg.Net>()));
    });
    calloc.free(cpath);
    return rval;
