...
class VideoCapture extends CvStruct<cvg.VideoCapture> {
  ...
  static final finalizer =
      OcvFinalizer<cvg.VideoCapturePtr>(ffi.Native.addressOf(cvg.VideoCapture_Close));
...
class VideoWriter extends CvStruct<cvg.VideoWriter> {
  ...
  static final finalizer =
      OcvFinalizer<cvg.VideoWriterPtr>(ffi.Native.addressOf(cvg.VideoWriter_Close));
