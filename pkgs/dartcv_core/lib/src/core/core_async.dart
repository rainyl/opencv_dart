...
Future<(double minVal, double maxVal, int minIdx, int maxIdx)> minMaxIdxAsync(
  ...
  return cvRunAsync0<(double, double, int, int)>(
    (callback) => mask == null
        ? ccore.core_MinMaxIdx_Async(src.ref, minValP, maxValP, minIdxP, maxIdxP, callback)
        : ccore.core_MinMaxIdx_Mask_Async(src.ref, mask.ref, minValP, maxValP, minIdxP, maxIdxP, callback),
    (c) {
