...
class QualityBRISQUE extends CvStruct<cvg.QualityBRISQUE> {
  ...
  factory QualityBRISQUE.create(String modelFile, String rangeFile) {
    ...
    cvRun(() => cffi.QualityBRISQUE_create(cm, cr, p));
    calloc.free(cm);
    calloc.free(cr);
  ...
  Future<Scalar> computeAsync(Mat img) => cvRunAsync<Scalar>(
        (callback) => cffi.QualityBRISQUE_compute_async(ref, img.ref, callback),
        scalarCompleter,
      );
  ...
  static Mat computeFeatures(Mat img, {Mat? features}) {
    features ??= Mat.empty();
    cvRun(() => cffi.QualityBRISQUE_computeFeatures_static(img.ref, features!.ref));
    return features;
  }
  ...
  static Future<Mat> computeFeaturesAsync(Mat img, {Mat? features}) => cvRunAsync0<Mat>(
        (callback) {
          features ??= Mat.empty();
          final status = cffi.QualityBRISQUE_computeFeatures_static_async(img.ref, features!.ref, callback);
          return status;
        },
        (c) => c.complete(features),
      );

  static final finalizer = OcvFinalizer<cvg.QualityBRISQUEPtr>(cffi.addresses.QualityBRISQUE_close);
  @override
...
class QualityGMSD extends CvStruct<cvg.QualityGMSD> {
  ...
  factory QualityGMSD.create(Mat ref) {
    ...
    cvRun(() => cffi.QualityGMSD_create(ref.ref, p));
  ...
  Scalar compute(Mat cmp) {
    final p = calloc<cvg.Scalar>();
    cvRun(() => cffi.QualityGMSD_compute(ref, cmp.ref, p));
    return Scalar.fromPointer(p);
  }

  /// async version of [compute]
  Future<Scalar> computeAsync(Mat cmp) => cvRunAsync<Scalar>(
        (callback) => cffi.QualityGMSD_compute_async(ref, cmp.ref, callback),
        scalarCompleter,
      );
  ...
  static (Scalar, Mat) compute1(Mat ref, Mat cmp, {Mat? qualityMap}) {
    ...
    cvRun(() => cffi.QualityGMSD_compute_static(ref.ref, cmp.ref, qualityMap!.ref, p));
  ...
  static Future<(Scalar, Mat qualityMap)> compute1Async(Mat ref, Mat cmp, {Mat? qualityMap}) =>
      cvRunAsync1<(Scalar, Mat)>(
        (callback) {
          qualityMap ??= Mat.empty();
          final status = cffi.QualityGMSD_compute_static_async(ref.ref, cmp.ref, qualityMap!.ref, callback);
          return status;
        },
        (c, p) => c.complete((Scalar.fromPointer(p.cast<cvg.Scalar>()), qualityMap!)),
      );

  static final finalizer = OcvFinalizer<cvg.QualityGMSDPtr>(cffi.addresses.QualityGMSD_close);
  @override
...
class QualityMSE extends CvStruct<cvg.QualityMSE> {
  ...
  factory QualityMSE.create(Mat ref) {
    ...
    cvRun(() => cffi.QualityMSE_create(ref.ref, p));
  ...
  Scalar compute(Mat cmpImgs) {
    final p = calloc<cvg.Scalar>();
    cvRun(() => cffi.QualityMSE_compute(ref, cmpImgs.ref, p));
    return Scalar.fromPointer(p);
  }

  /// async version of [compute]
  Future<Scalar> computeAsync(Mat cmpImgs) => cvRunAsync<Scalar>(
        (callback) => cffi.QualityMSE_compute_async(ref, cmpImgs.ref, callback),
  ...
  static (Scalar, Mat qualityMap) compute1(Mat ref, Mat cmp, {Mat? qualityMap}) {
    final p = calloc<cvg.Scalar>();
    qualityMap ??= Mat.empty();
    cvRun(() => cffi.QualityMSE_compute_static(ref.ref, cmp.ref, qualityMap!.ref, p));
    return (Scalar.fromPointer(p), qualityMap);
  }
  ...
  static Future<(Scalar, Mat qualityMap)> compute1Async(Mat ref, Mat cmp, {Mat? qualityMap}) =>
      cvRunAsync1<(Scalar, Mat)>(
        (callback) {
          qualityMap ??= Mat.empty();
          final status = cffi.QualityMSE_compute_static_async(ref.ref, cmp.ref, qualityMap!.ref, callback);
          return status;
        },
        (c, p) => c.complete((Scalar.fromPointer(p.cast<cvg.Scalar>()), qualityMap!)),
      );

  static final finalizer = OcvFinalizer<cvg.QualityMSEPtr>(cffi.addresses.QualityMSE_close);
  @override
...
class QualityPSNR extends CvStruct<cvg.QualityPSNR> {
  ...
  factory QualityPSNR.create(Mat ref, {double maxPixelValue = 255}) {
    ...
    cvRun(() => cffi.QualityPSNR_create(ref.ref, maxPixelValue, p));
  ...
  Scalar compute(Mat cmp) {
    final p = calloc<cvg.Scalar>();
    cvRun(() => cffi.QualityPSNR_compute(ref, cmp.ref, p));
    return Scalar.fromPointer(p);
  }

  /// async version of [compute]
  Future<Scalar> computeAsync(Mat cmp) => cvRunAsync<Scalar>(
        (callback) => cffi.QualityPSNR_compute_async(ref, cmp.ref, callback),
        scalarCompleter,
      );
  ...
  static (Scalar, Mat qualityMap) compute1(Mat ref, Mat cmp, {Mat? qualityMap, double maxPixelValue = 255}) {
    final p = calloc<cvg.Scalar>();
    qualityMap ??= Mat.empty();
    cvRun(() => cffi.QualityPSNR_compute_static(ref.ref, cmp.ref, maxPixelValue, qualityMap!.ref, p));
    return (Scalar.fromPointer(p), qualityMap);
  }
  ...
  static Future<(Scalar, Mat qualityMap)> compute1Async(
    ...
    double maxPixelValue = 255,
      ...
      cvRunAsync<(Scalar, Mat)>(
        (callback) {
          qualityMap ??= Mat.empty();
          final status = cffi.QualityPSNR_compute_static_async(
            ref.ref,
            cmp.ref,
            maxPixelValue,
            qualityMap!.ref,
  ...
  double get maxPixelValue => cffi.QualityPSNR_getMaxPixelValue(ref);
  set maxPixelValue(double value) => cffi.QualityPSNR_setMaxPixelValue(ref, value);

  static final finalizer = OcvFinalizer<cvg.QualityPSNRPtr>(cffi.addresses.QualityPSNR_close);
  @override
...
class QualitySSIM extends CvStruct<cvg.QualitySSIM> {
  ...
  factory QualitySSIM.create(Mat ref) {
    ...
    cvRun(() => cffi.QualitySSIM_create(ref.ref, p));
  ...
  Scalar compute(Mat cmp) {
    final p = calloc<cvg.Scalar>();
    cvRun(() => cffi.QualitySSIM_compute(ref, cmp.ref, p));
    return Scalar.fromPointer(p);
  }

  /// async version of [compute]
  Future<Scalar> computeAsync(Mat cmp) => cvRunAsync<Scalar>(
        (callback) => cffi.QualitySSIM_compute_async(ref, cmp.ref, callback),
        scalarCompleter,
      );
  ...
  static (Scalar, Mat qualityMap) compute1(Mat ref, Mat cmp, {Mat? qualityMap}) {
    final p = calloc<cvg.Scalar>();
    qualityMap ??= Mat.empty();
    cvRun(() => cffi.QualitySSIM_compute_static(ref.ref, cmp.ref, qualityMap!.ref, p));
    return (Scalar.fromPointer(p), qualityMap);
  }
  ...
  static Future<(Scalar, Mat qualityMap)> compute1Async(
    ...
    Mat? qualityMap,
      ...
      cvRunAsync<(Scalar, Mat)>(
        (callback) {
          qualityMap ??= Mat.empty();
          final status = cffi.QualitySSIM_compute_static_async(ref.ref, cmp.ref, qualityMap!.ref, callback);
          return status;
        },
        (c, p) => c.complete((Scalar.fromPointer(p.cast<cvg.Scalar>()), qualityMap!)),
      );

  static final finalizer = OcvFinalizer<cvg.QualitySSIMPtr>(cffi.addresses.QualitySSIM_close);
  @override
