...
extension MergeMertensAsync on MergeMertens {
  static Future<MergeMertens> emptyNewAsync() async => cvRunAsync(
        ccore.MergeMertens_Create_Async,
  ...
  static Future<MergeMertens> createAsync({
    ...
    return cvRunAsync(
      (callback) => ccore.MergeMertens_CreateWithParams_Async(
        contrastWeight,
        saturationWeight,
        exposureWeight,
        callback,
  ...
  Future<Mat> processAsync(VecMat src) async {
    return cvRunAsync(
      (callback) => ccore.MergeMertens_Process_Async(ref, src.ref, callback),
...
extension AlignMTBAsync on AlignMTB {
  ...
  static Future<AlignMTB> createAsync({
    ...
    return cvRunAsync(
      (callback) => ccore.AlignMTB_CreateWithParams_Async(
        maxBits,
        excludeRange,
        cut,
        callback,
  ...
  Future<VecMat> processAsync(VecMat src) async {
    return cvRunAsync(
      (callback) => ccore.AlignMTB_Process_Async(ref, src.ref, callback),
...
Future<Mat> colorChangeAsync(
  ...
  return cvRunAsync(
    (callback) => ccore.ColorChange_Async(
      src.ref,
      mask.ref,
      redMul,
      greenMul,
...
Future<Mat> seamlessCloneAsync(
  ...
  return cvRunAsync(
    (callback) => ccore.SeamlessClone_Async(
      src.ref,
      dst.ref,
      mask.ref,
      p.ref,
...
Future<Mat> illuminationChangeAsync(
  ...
  return cvRunAsync(
    (callback) => ccore.IlluminationChange_Async(
      src.ref,
      mask.ref,
      alpha,
      beta,
...
Future<Mat> textureFlatteningAsync(
  ...
  return cvRunAsync(
    (callback) => ccore.TextureFlattening_Async(
      src.ref,
      mask.ref,
      lowThreshold,
      highThreshold,
...
Future<Mat> fastNlMeansDenoisingAsync(
  ...
  return cvRunAsync(
    (callback) => ccore.FastNlMeansDenoisingWithParams_Async(
      src.ref,
      h,
      templateWindowSize,
      searchWindowSize,
...
Future<Mat> fastNlMeansDenoisingColoredAsync(
  ...
  return cvRunAsync(
    (callback) => ccore.FastNlMeansDenoisingColoredWithParams_Async(
      src.ref,
      h,
      hColor,
      templateWindowSize,
...
Future<Mat> fastNlMeansDenoisingColoredMultiAsync(
  ...
  return cvRunAsync(
    (callback) => ccore.FastNlMeansDenoisingColoredMultiWithParams_Async(
      srcImgs.ref,
      imgToDenoiseIndex,
      temporalWindowSize,
      h,
...
Future<Mat> detailEnhanceAsync(
  ...
  return cvRunAsync(
    (callback) => ccore.DetailEnhance_Async(
      src.ref,
      sigmaS,
      sigmaR,
      callback,
...
Future<Mat> edgePreservingFilterAsync(
  ...
  return cvRunAsync(
    (callback) => ccore.EdgePreservingFilter_Async(
      src.ref,
      flags,
      sigmaS,
      sigmaR,
...
Future<(Mat dst1, Mat dst2)> pencilSketchAsync(
  ...
  return cvRunAsync2(
    (callback) => ccore.PencilSketch_Async(
      src.ref,
      sigmaS,
      sigmaR,
      shadeFactor,
...
Future<Mat> stylizationAsync(
  ...
  return cvRunAsync(
    (callback) => ccore.Stylization_Async(
      src.ref,
      sigmaS,
      sigmaR,
      callback,
...
Future<Mat> inpaintAsync(
  ...
  return cvRunAsync(
    (callback) => ccore.PhotoInpaint_Async(
      src.ref,
      inpaintMask.ref,
      inpaintRadius,
      flags,
