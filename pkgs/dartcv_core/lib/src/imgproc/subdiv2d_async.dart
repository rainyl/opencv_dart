...
extension Subdiv2DAsync on Subdiv2D {
  ...
  Future<(int rval, Point2f nearestPt)> findNearestAsync(Point2f pt) async =>
      cvRunAsync2((callback) => cffi.Subdiv2D_FindNearest_Async(ref, pt.ref, callback),
          (completer, p, p1) {
        final rval = p.cast<ffi.Int>().value;
        calloc.free(p);
        completer.complete((rval, Point2f.fromPointer(p1.cast<cvg.Point2f>())));
  ...
  Future<VecI32> getLeadingEdgeListAsync() async =>
      cvRunAsync((callback) => cffi.Subdiv2D_GetLeadingEdgeList_Async(ref, callback), vecI32Completer);
  ...
  Future<(int rval, int edge, int vertex)> locateAsync(Point2f pt) async =>
      cvRunAsync3((callback) => cffi.Subdiv2D_Locate_Async(ref, pt.ref, callback),
          (completer, p, p1, p2) {
        final rval = p.cast<ffi.Int>().value;
        calloc.free(p);
