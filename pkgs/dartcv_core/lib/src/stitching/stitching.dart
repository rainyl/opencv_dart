...
class Stitcher extends CvStruct<cvg.Stitcher> {
  ...
  factory Stitcher.create({StitcherMode mode = StitcherMode.PANORAMA}) {
    ...
    cvRun(() => ccore.Stitcher_Create(mode.index, ptr_));
  ...
  double get registrationResol {
    return using<double>((arena) {
      ...
      cvRun(() => ccore.Stitcher_GetRegistrationResol(ref, rptr));
      return rptr.value;
    });
  }
  ...
  set registrationResol(double value) {
    cvRun(() => ccore.Stitcher_SetRegistrationResol(ref, value));
  }
  ...
  double get seamEstimationResol {
    return using<double>((arena) {
      final rptr = arena<ffi.Double>();
      cvRun(() => ccore.Stitcher_GetSeamEstimationResol(ref, rptr));
      return rptr.value;
    });
  }
  ...
  set seamEstimationResol(double value) {
    cvRun(() => ccore.Stitcher_SetSeamEstimationResol(ref, value));
  }
  ...
  double get compositingResol {
    return using<double>((arena) {
      final rptr = arena<ffi.Double>();
      cvRun(() => ccore.Stitcher_GetCompositingResol(ref, rptr));
      return rptr.value;
    });
  }
  ...
  set compositingResol(double value) {
    cvRun(() => ccore.Stitcher_SetCompositingResol(ref, value));
  }
  ...
  double get panoConfidenceThresh {
    return using<double>((arena) {
      final rptr = arena<ffi.Double>();
      cvRun(() => ccore.Stitcher_GetPanoConfidenceThresh(ref, rptr));
      return rptr.value;
    });
  }
  ...
  set panoConfidenceThresh(double value) {
    cvRun(() => ccore.Stitcher_SetPanoConfidenceThresh(ref, value));
  }
  ...
  bool get waveCorrection {
    return using<bool>((arena) {
      ...
      cvRun(() => ccore.Stitcher_GetWaveCorrection(ref, rptr));
      return rptr.value;
    });
  }
  ...
  set waveCorrection(bool value) {
    cvRun(() => ccore.Stitcher_SetWaveCorrection(ref, value));
  }
  ...
  int get interpolationFlags {
    return using<int>((arena) {
      ...
      cvRun(() => ccore.Stitcher_GetInterpolationFlags(ref, rptr));
      return rptr.value;
    });
  }
  ...
  set interpolationFlags(int value) {
    cvRun(() => ccore.Stitcher_SetInterpolationFlags(ref, value));
  }
  ...
  int get waveCorrectKind {
    return using<int>((arena) {
      final rptr = arena<ffi.Int>();
      cvRun(() => ccore.Stitcher_GetWaveCorrectKind(ref, rptr));
      return rptr.value;
    });
  }
  ...
  set waveCorrectKind(int value) {
    cvRun(() => ccore.Stitcher_SetWaveCorrectKind(ref, value));
  }
  ...
  StitcherStatus estimateTransform(VecMat images, {VecMat? masks}) {
    return using<StitcherStatus>((arena) {
      ...
      cvRun(() => ccore.Stitcher_EstimateTransform(ref, images.ref, masks!.ref, rptr));
  ...
  (StitcherStatus, Mat pano) composePanorama({VecMat? images}) {
    return using<(StitcherStatus, Mat)>((arena) {
      ...
      images == null
          ? cvRun(() => ccore.Stitcher_ComposePanorama(ref, rpano.ref, rptr))
          : cvRun(() => ccore.Stitcher_ComposePanorama_1(ref, images.ref, rpano.ref, rptr));
  ...
  (StitcherStatus, Mat pano) stitch(VecMat images, {VecMat? masks}) {
    return using<(StitcherStatus, Mat)>((arena) {
      ...
      final rpano = Mat.empty();
      masks == null
          ? cvRun(() => ccore.Stitcher_Stitch(ref, images.ref, rpano.ref, rptr))
          : cvRun(() => ccore.Stitcher_Stitch_1(ref, images.ref, masks.ref, rpano.ref, rptr));
      return (StitcherStatus.fromInt(rptr.value), rpano);
    });
  }
  ...
  VecI32 get component {
    ...
    cvRun(() => ccore.Stitcher_Component(ref, rptr));
    return VecI32.fromPointer(rptr);
  }

  static final finalizer = OcvFinalizer<cvg.StitcherPtr>(ccore.addresses.Stitcher_Close);

  void dispose() {
    finalizer.detach(this);
    ccore.Stitcher_Close(ptr);
  }
