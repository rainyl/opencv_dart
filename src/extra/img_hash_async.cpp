...
CvStatus *pHashCompute_Async(Mat inputArr, Mat outputArr, CvCallback_0 callback) {
    BEGIN_WRAP
...
CvStatus *averageHashCompute_Async(Mat inputArr, Mat outputArr, CvCallback_0 callback) {
    BEGIN_WRAP
...
CvStatus *BlockMeanHash_Compute_Async(BlockMeanHash self, Mat inputArr, Mat outputArr, CvCallback_0 callback) {
    BEGIN_WRAP
    self.ptr->get()->compute(*inputArr.ptr, *outputArr.ptr);
    callback();
    END_WRAP
}
...
CvStatus *colorMomentHashCompute_Async(Mat inputArr, Mat outputArr, CvCallback_0 callback) {
    BEGIN_WRAP
...
CvStatus *marrHildrethHashCompute_Async(Mat inputArr, Mat outputArr, float alpha, float scale, CvCallback_0 callback) {
    BEGIN_WRAP
...
CvStatus *radialVarianceHashCompute_Async(Mat inputArr, Mat outputArr, double sigma, int numOfAngleLine, CvCallback_0 callback) {
    BEGIN_WRAP
