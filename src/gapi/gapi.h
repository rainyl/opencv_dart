...
CvStatus gapi_dilate(const GMat src, const Mat kernel, const Point anchor, int iterations, int borderType,
                     const Scalar borderValue, GMat *rval);
CvStatus gapi_dilate3x3(const GMat src, int iterations, int borderType, const Scalar borderValue, GMat *rval);
...
CvStatus gapi_Canny(const GMat image, double threshold1, double threshold2, int apertureSize, bool L2gradient,
                    GMat *rval);
