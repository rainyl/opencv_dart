...
CvStatus RotatedRect_Points_Async(RotatedRect rect, VecPoint2fCallback callback);
CvStatus RotatedRect_BoundingRect_Async(RotatedRect rect, RectCallback callback);
CvStatus RotatedRect_BoundingRect2f_Async(RotatedRect rect, Rect2fCallback callback);

CvStatus Mat_New_Async(MatCallback callback);
CvStatus Mat_NewWithSize_Async(int rows, int cols, int type, MatCallback callback);
CvStatus Mat_NewWithSizes_Async(VecInt sizes, int type, MatCallback callback);
CvStatus Mat_NewWithSizesFromScalar_Async(VecInt sizes, int type, Scalar ar, MatCallback callback);
CvStatus Mat_NewWithSizesFromBytes_Async(VecInt sizes, int type, VecChar buf, MatCallback callback);
CvStatus Mat_NewFromScalar_Async(const Scalar ar, int type, MatCallback callback);
CvStatus Mat_NewWithSizeFromScalar_Async(const Scalar ar, int rows, int cols, int type, MatCallback callback);
CvStatus Mat_NewFromBytes_Async(int rows, int cols, int type, void *buf, int step, MatCallback callback);
CvStatus Mat_NewFromVecPoint_Async(VecPoint vec, MatCallback callback);
CvStatus Mat_NewFromVecPoint2f_Async(VecPoint2f vec, MatCallback callback);
CvStatus Mat_NewFromVecPoint3f_Async(VecPoint3f vec, MatCallback callback);
CvStatus Mat_FromPtr_Async(Mat m, int rows, int cols, int type, int prows, int pcols, MatCallback callback);
CvStatus Mat_FromCMat_Async(Mat m, MatCallback callback);

// functions without return values shouldn't have callbacks?
void Mat_Close_Async(MatPtr m, NoArgCallback callback);
// TODO
CvStatus Mat_Release_Async(Mat *m);
CvStatus Mat_Empty_Async(Mat m, bool *rval);
CvStatus Mat_IsContinuous_Async(Mat m, bool *rval);
CvStatus Mat_Clone_Async(Mat m, MatCallback callback);
...
CvStatus Mat_Region_Async(Mat m, Rect r, MatCallback callback);
CvStatus Mat_Reshape_Async(Mat m, int cn, int rows, MatCallback callback);
CvStatus Mat_PatchNaNs_Async(Mat m, double val);
CvStatus Mat_ConvertFp16_Async(Mat m, MatCallback callback);
CvStatus Mat_Mean_Async(Mat m, Scalar *rval);
CvStatus Mat_MeanWithMask_Async(Mat m, Mat mask, Scalar *rval);
CvStatus Mat_Sqrt_Async(Mat m, MatCallback callback);
...
CvStatus Eye_Async(int rows, int cols, int type, MatCallback callback);
CvStatus Zeros_Async(int rows, int cols, int type, MatCallback callback);
CvStatus Ones_Async(int rows, int cols, int type, MatCallback callback);
...
CvStatus Mat_MultiplyMatrix_Async(Mat x, Mat y, MatCallback callback);
...
CvStatus Mat_T_Async(Mat x, MatCallback callback);
...
CvStatus Mat_rowRange_Async(Mat m, int start, int end, MatCallback callback);
CvStatus Mat_colRange_Async(Mat m, int start, int end, MatCallback callback);
