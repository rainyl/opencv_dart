...
ffigen:
	...
	dart --enable-experiment=native-assets run ffigen --config ffigen/ffigen_video.yaml
	dart --enable-experiment=native-assets run ffigen --config ffigen/ffigen_videoio.yaml
