...
void main() async {
  test('Mat Creation', () {
    ...
    final mat1 = cv.Mat.create(width: 100, height: 100, r: 255, g: 255, b: 255);
  ...
  test('Mat operations Subtract', () {
    ...
    final mat2_1 = mat1.clone();
    mat2_1.subtract<cv.Mat>(mat0, inplace: true);
  ...
  test("cv.convertScaleAbs", () {
    final src = cv.Mat.create(width: 100, height: 100, type: cv.MatType.CV_32FC1);
